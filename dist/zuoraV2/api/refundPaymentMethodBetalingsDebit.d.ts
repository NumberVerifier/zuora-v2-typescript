 ...
 */
import type { RefundPaymentMethodBetalingsDebitMandate } from './refundPaymentMethodBetalingsDebitMandate';
/**
 * If the `type` of the payment method is `betalings_debit`, this hash contains details about the Betalingsservice bank account.
 */
export type RefundPaymentMethodBetalingsDebit = {
    ...
    mandate?: RefundPaymentMethodBetalingsDebitMandate;
};
//# sourceMappingURL=refundPaymentMethodBetalingsDebit.d.ts.map