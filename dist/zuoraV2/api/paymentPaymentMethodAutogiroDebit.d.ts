 ...
 */
import type { PaymentPaymentMethodAutogiroDebitMandate } from './paymentPaymentMethodAutogiroDebitMandate';
/**
 * If the `type` of the payment method is `autogiro_debit`, this hash contains details about the Autogiro bank account.
 */
export type PaymentPaymentMethodAutogiroDebit = {
    ...
    mandate?: PaymentPaymentMethodAutogiroDebitMandate;
};
//# sourceMappingURL=paymentPaymentMethodAutogiroDebit.d.ts.map