 ...
 */
import type { RefundPaymentMethodPadDebitMandate } from './refundPaymentMethodPadDebitMandate';
/**
 * If the `type` of the payment method is `pad_debit`, this hash contains details about the PAD bank account.
 */
export type RefundPaymentMethodPadDebit = {
    ...
    mandate?: RefundPaymentMethodPadDebitMandate;
};
//# sourceMappingURL=refundPaymentMethodPadDebit.d.ts.map