 ...
 */
import type { BillRunPreviewAssumeRenewal } from './billRunPreviewAssumeRenewal';
import type { BillRunPreviewChargesExcludedItem } from './billRunPreviewChargesExcludedItem';
import type { BillRunPreviewCustomFields } from './billRunPreviewCustomFields';
import type { BillRunPreviewCustomObjects } from './billRunPreviewCustomObjects';
import type { BillRunPreviewFileProperty } from './billRunPreviewFileProperty';
import type { BillRunPreviewState } from './billRunPreviewState';
import type { BillRunPreviewStateTransitionsProperty } from './billRunPreviewStateTransitionsProperty';
/**
 */
export interface BillRunPreview {
    ...
    assume_renewal?: BillRunPreviewAssumeRenewal;
    ...
    number_of_accounts_succeeded?: number;
    /** The state of the bill run preview. */
    state?: BillRunPreviewState;
    /** The timestamps at which the object's state was updated. */
    state_transitions?: BillRunPreviewStateTransitionsProperty;
...
//# sourceMappingURL=billRunPreview.d.ts.map