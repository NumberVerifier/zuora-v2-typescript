 ...
 */
import type { PaymentPaymentMethodPadDebitMandate } from './paymentPaymentMethodPadDebitMandate';
/**
 * If the `type` of the payment method is `pad_debit`, this hash contains details about the PAD bank account.
 */
export type PaymentPaymentMethodPadDebit = {
    ...
    mandate?: PaymentPaymentMethodPadDebitMandate;
};
//# sourceMappingURL=paymentPaymentMethodPadDebit.d.ts.map