 ...
 */
import type { PaymentMethodBetalingsDebitMandate } from './paymentMethodBetalingsDebitMandate';
/**
 * If the `type` of the payment method is `betalings_debit`, this hash contains details about the Betalingsservice bank account.
 */
export type PaymentMethodBetalingsDebit = {
    ...
    mandate?: PaymentMethodBetalingsDebitMandate;
};
//# sourceMappingURL=paymentMethodBetalingsDebit.d.ts.map