 ...
 */
import type { PaymentMethodPadDebitMandate } from './paymentMethodPadDebitMandate';
/**
 * If the `type` of the payment method is `pad_debit`, this hash contains details about the PAD bank account.
 */
export type PaymentMethodPadDebit = {
    ...
    mandate?: PaymentMethodPadDebitMandate;
};
//# sourceMappingURL=paymentMethodPadDebit.d.ts.map