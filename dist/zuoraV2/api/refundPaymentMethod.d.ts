...
import type { RefundPaymentMethodAchDebit } from './refundPaymentMethodAchDebit';
import type { RefundPaymentMethodApplePay } from './refundPaymentMethodApplePay';
import type { RefundPaymentMethodAuBecsDebit } from './refundPaymentMethodAuBecsDebit';
import type { RefundPaymentMethodAutogiroDebit } from './refundPaymentMethodAutogiroDebit';
import type { RefundPaymentMethodBacsDebit } from './refundPaymentMethodBacsDebit';
import type { RefundPaymentMethodBetalingsDebit } from './refundPaymentMethodBetalingsDebit';
import type { RefundPaymentMethodBillingDetails } from './refundPaymentMethodBillingDetails';
import type { RefundPaymentMethodCard } from './refundPaymentMethodCard';
import type { RefundPaymentMethodCcRef } from './refundPaymentMethodCcRef';
import type { RefundPaymentMethodCustomFields } from './refundPaymentMethodCustomFields';
import type { RefundPaymentMethodCustomObjects } from './refundPaymentMethodCustomObjects';
import type { RefundPaymentMethodGooglePay } from './refundPaymentMethodGooglePay';
import type { RefundPaymentMethodNzBecsDebit } from './refundPaymentMethodNzBecsDebit';
import type { RefundPaymentMethodPadDebit } from './refundPaymentMethodPadDebit';
import type { RefundPaymentMethodPaypalAdaptive } from './refundPaymentMethodPaypalAdaptive';
import type { RefundPaymentMethodPaypalExpress } from './refundPaymentMethodPaypalExpress';
import type { RefundPaymentMethodPaypalExpressNative } from './refundPaymentMethodPaypalExpressNative';
import type { RefundPaymentMethodSepaDebit } from './refundPaymentMethodSepaDebit';
import type { RefundPaymentMethodState } from './refundPaymentMethodState';
import type { RefundPaymentMethodType } from './refundPaymentMethodType';
/**
...
export type RefundPaymentMethod = {
    ...
    ach_debit?: RefundPaymentMethodAchDebit;
    ...
    betalings_debit?: RefundPaymentMethodBetalingsDebit;
    /** Billing information associated with the payment method that may be used or required by specific payment method types. */
    billing_details?: RefundPaymentMethodBillingDetails;
    /** Credit card information. */
    card?: RefundPaymentMethodCard;
...
//# sourceMappingURL=refundPaymentMethod.d.ts.map