 ...
 */
import type { PaymentPaymentMethodAuBecsDebitMandate } from './paymentPaymentMethodAuBecsDebitMandate';
/**
 * If the `type` of the payment method is `au_becs_debit`, this hash contains details about the BECS bank account.
 */
export type PaymentPaymentMethodAuBecsDebit = {
    ...
    mandate?: PaymentPaymentMethodAuBecsDebitMandate;
};
//# sourceMappingURL=paymentPaymentMethodAuBecsDebit.d.ts.map