 ...
 */
import type { RefundPaymentMethodAuBecsDebitMandate } from './refundPaymentMethodAuBecsDebitMandate';
/**
 * If the `type` of the payment method is `au_becs_debit`, this hash contains details about the BECS bank account.
 */
export type RefundPaymentMethodAuBecsDebit = {
    ...
    mandate?: RefundPaymentMethodAuBecsDebitMandate;
};
//# sourceMappingURL=refundPaymentMethodAuBecsDebit.d.ts.map