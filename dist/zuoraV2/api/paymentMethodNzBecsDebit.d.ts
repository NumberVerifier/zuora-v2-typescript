 ...
 */
import type { PaymentMethodNzBecsDebitMandate } from './paymentMethodNzBecsDebitMandate';
/**
 * If the `type` of the payment method is `nz_becs_debit`, this hash contains details about the BECS-NZ bank account.
 */
export type PaymentMethodNzBecsDebit = {
    ...
    mandate?: PaymentMethodNzBecsDebitMandate;
};
//# sourceMappingURL=paymentMethodNzBecsDebit.d.ts.map