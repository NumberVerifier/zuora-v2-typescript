...
import type { SubscriptionResumePatchResponseResumeAt } from './subscriptionResumePatchResponseResumeAt';
/**
 * Specify this field if you want to resume a subscription.
 */
export interface SubscriptionResumePatchResponse {
    ...
    resume_at?: SubscriptionResumePatchResponseResumeAt;
    /** Date on which the paused subscription is resumed. */
    resume_date?: string;
}
//# sourceMappingURL=subscriptionResumePatchResponse.d.ts.map