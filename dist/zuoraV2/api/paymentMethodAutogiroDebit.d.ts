 ...
 */
import type { PaymentMethodAutogiroDebitMandate } from './paymentMethodAutogiroDebitMandate';
/**
 * If the `type` of the payment method is `autogiro_debit`, this hash contains details about the Autogiro bank account.
 */
export type PaymentMethodAutogiroDebit = {
    ...
    mandate?: PaymentMethodAutogiroDebitMandate;
};
//# sourceMappingURL=paymentMethodAutogiroDebit.d.ts.map