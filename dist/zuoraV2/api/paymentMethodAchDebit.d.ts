 ...
 */
import type { PaymentMethodAchDebitBankAccountType } from './paymentMethodAchDebitBankAccountType';
import type { PaymentMethodAchDebitMandate } from './paymentMethodAchDebitMandate';
/**
 * If the `type` of the payment method is `ach_debit`, this hash contains details about the ACH bank account.
 */
export type PaymentMethodAchDebit = {
    ...
    bank_account_type: PaymentMethodAchDebitBankAccountType;
    ...
    mandate?: PaymentMethodAchDebitMandate;
};
//# sourceMappingURL=paymentMethodAchDebit.d.ts.map