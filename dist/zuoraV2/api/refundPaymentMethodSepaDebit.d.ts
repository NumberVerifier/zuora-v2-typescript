 ...
 */
import type { RefundPaymentMethodSepaDebitMandate } from './refundPaymentMethodSepaDebitMandate';
/**
 * If the `type` of the payment method is `sepa_debit`, this hash contains details about the SEPA bank account.
 */
export type RefundPaymentMethodSepaDebit = {
    ...
    mandate?: RefundPaymentMethodSepaDebitMandate;
};
//# sourceMappingURL=refundPaymentMethodSepaDebit.d.ts.map