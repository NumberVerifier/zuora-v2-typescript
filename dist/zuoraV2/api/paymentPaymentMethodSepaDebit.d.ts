 ...
 */
import type { PaymentPaymentMethodSepaDebitMandate } from './paymentPaymentMethodSepaDebitMandate';
/**
 * If the `type` of the payment method is `sepa_debit`, this hash contains details about the SEPA bank account.
 */
export type PaymentPaymentMethodSepaDebit = {
    ...
    mandate?: PaymentPaymentMethodSepaDebitMandate;
};
//# sourceMappingURL=paymentPaymentMethodSepaDebit.d.ts.map