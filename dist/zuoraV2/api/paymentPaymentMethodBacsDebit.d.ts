 ...
 */
import type { PaymentPaymentMethodBacsDebitMandate } from './paymentPaymentMethodBacsDebitMandate';
/**
 * If the `type` of the payment method is `bacs_debit`,, this hash contains details about the BACS bank account.
 */
export type PaymentPaymentMethodBacsDebit = {
    ...
    mandate?: PaymentPaymentMethodBacsDebitMandate;
};
//# sourceMappingURL=paymentPaymentMethodBacsDebit.d.ts.map