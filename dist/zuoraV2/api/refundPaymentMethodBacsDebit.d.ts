 ...
 */
import type { RefundPaymentMethodBacsDebitMandate } from './refundPaymentMethodBacsDebitMandate';
/**
 * If the `type` of the payment method is `bacs_debit`,, this hash contains details about the BACS bank account.
 */
export type RefundPaymentMethodBacsDebit = {
    ...
    mandate?: RefundPaymentMethodBacsDebitMandate;
};
//# sourceMappingURL=refundPaymentMethodBacsDebit.d.ts.map