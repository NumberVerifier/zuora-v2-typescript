 ...
 */
import type { PaymentPaymentMethodNzBecsDebitMandate } from './paymentPaymentMethodNzBecsDebitMandate';
/**
 * If the `type` of the payment method is `nz_becs_debit`, this hash contains details about the BECS-NZ bank account.
 */
export type PaymentPaymentMethodNzBecsDebit = {
    ...
    mandate?: PaymentPaymentMethodNzBecsDebitMandate;
};
//# sourceMappingURL=paymentPaymentMethodNzBecsDebit.d.ts.map