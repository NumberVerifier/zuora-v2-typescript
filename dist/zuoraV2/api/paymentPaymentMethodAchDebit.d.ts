 ...
 */
import type { PaymentPaymentMethodAchDebitBankAccountType } from './paymentPaymentMethodAchDebitBankAccountType';
import type { PaymentPaymentMethodAchDebitMandate } from './paymentPaymentMethodAchDebitMandate';
/**
 * If the `type` of the payment method is `ach_debit`, this hash contains details about the ACH bank account.
 */
export type PaymentPaymentMethodAchDebit = {
    ...
    bank_account_type: PaymentPaymentMethodAchDebitBankAccountType;
    ...
    mandate?: PaymentPaymentMethodAchDebitMandate;
};
//# sourceMappingURL=paymentPaymentMethodAchDebit.d.ts.map