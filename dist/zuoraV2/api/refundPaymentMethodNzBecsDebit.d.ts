 ...
 */
import type { RefundPaymentMethodNzBecsDebitMandate } from './refundPaymentMethodNzBecsDebitMandate';
/**
 * If the `type` of the payment method is `nz_becs_debit`, this hash contains details about the BECS-NZ bank account.
 */
export type RefundPaymentMethodNzBecsDebit = {
    ...
    mandate?: RefundPaymentMethodNzBecsDebitMandate;
};
//# sourceMappingURL=refundPaymentMethodNzBecsDebit.d.ts.map