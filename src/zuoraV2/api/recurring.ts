 ...
 */
import type { RecurringAlignmentBehavior } from './recurringAlignmentBehavior';
import type { RecurringDurationInterval } from './recurringDurationInterval';
import type { RecurringInterval } from './recurringInterval';
import type { RecurringOn } from './recurringOn';
import type { RecurringRatingGroup } from './recurringRatingGroup';
import type { RecurringRecurringOn } from './recurringRecurringOn';
import type { RecurringTiming } from './recurringTiming';
...
export interface Recurring {
  ...
  alignment_behavior?: RecurringAlignmentBehavior;
  /** Specifies the duration frequency. One of day, week, month or year. */
  duration_interval?: RecurringDurationInterval;
  ...
  rating_group?: RecurringRatingGroup;
  /** Specifies on which day or the month or day of the week a customer shall be billed. */
  recurring_on?: RecurringRecurringOn;
  /** You can choose to bill in_advance or in_arrears for recurring prices. The field is not used with one-time or usage-based prices. */
